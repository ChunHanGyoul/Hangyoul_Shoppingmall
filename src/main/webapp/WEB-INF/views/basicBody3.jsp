...
<head>
  ...
  <link rel="stylesheet" href="resources/css/basicBody.css" type="text/css">
  <base target="_self"/>
...
<input type="hidden" value="${success}" id="success"/>
    ...
    <header>
      <div id="header">
        ...
        <p style="position:absolute; left:40px; top:-27px;">
          <a href="../mainPage" class="MenuLink">
 ...
 <!--메뉴버튼-->
    <div class="MenuBtnSide" id="rightMenu">
      ...
      <a href="../myPage" class="MenuLink"><font style="font-family:'Nanum Pen Script', cursive; font-size:1cm; color:white;">마이페이지</font></a></br>
      <a href="../viewCart" class="MenuLink"><font style="font-family:'Nanum Pen Script', cursive; font-size:1cm; color:white;">장바구니</font></a></br>
      <a href="../showDelivery" class="MenuLink"><font style="font-family:'Nanum Pen Script', cursive; font-size:1cm; color:white;">배송상태확인</font></a></br>
    ...
    <div class="MenuBtn">
      <img src="<%=request.getContextPath() %>/resources/image/menuBtn.png" alt="메뉴버튼" onclick="openRightMenu()" style="cursor:pointer;"><font style="font-family:'Nanum Pen Script', cursive; font-size:1cm; cursor:pointer;" onclick="openRightMenu()"> Menu</font></button>
    </div>
    <!--메뉴버튼-->
    
     <!--리모컨-->
    <div class="ScrollTopBtn">
      <a href="#"><img src="<%=request.getContextPath() %>/resources/image/button.jpg" alt=""></a>
    </div>
    <div class="ScrollHomeBtn">
      <img src="<%=request.getContextPath() %>/resources/image/home.jpg" alt="" width="8%">
    </div>
    <div class="ScrollSerchBtn">
      <img src="<%=request.getContextPath() %>/resources/image/serch.jpg" alt="" width="8%">
    </div>
    <div class="ScrollDownBtn">
      <a href="#"><img src="<%=request.getContextPath() %>/resources/image/button2.jpg" alt=""></a>
    </div>
    <!--리모컨-->
  <!--로그인-->
...
<script src="<%=request.getContextPath() %>/resources/js/bagicLoginState.js"></script>
